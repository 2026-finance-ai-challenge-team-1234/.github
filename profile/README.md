# 2026 금융 AI Challenge - Team: 일이삼사

## 🏦 공모전 주제

**생성형 AI 기반 금융사기 예방 모의훈련 서비스 '미리살핌'**
보이스피싱·스미싱·피싱 상황을 생성형 AI와의 대화로 안전하게 체험하고, 사용자의 판단 시점과 위험 행동을 분석해 개인화된 예방 가이드를 제공하는 금융사기 대응 훈련 서비스입니다.
